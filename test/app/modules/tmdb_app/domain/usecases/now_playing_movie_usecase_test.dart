...
import 'package:tmdb_app/app/modules/tmdb_app/domain/usecases/now_playing_movie_usecase.dart';
...
void main() {
  ...
  final usecase =
      NowPLayingMovieUsecaseImpl(repository: repository, logger: logger);
  ...
  test('should return a list of movies', () async {
    ...
    when(() => repository.nowPlaying(language: language, page: page))
