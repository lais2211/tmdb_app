...
import 'package:tmdb_app/app/modules/tmdb_app/domain/usecases/top_rated_movie_usecase.dart';
...
void main() {
  ...
  final usecase =
      TopRatedMovieUsecaseImpl(repository: repository, logger: logger);
  ...
  test('should return a list of movies', () async {
    ...
    when(() => repository.topRated(language: language, page: page))
